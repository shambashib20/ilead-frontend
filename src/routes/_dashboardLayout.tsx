...
function RouteComponent() {
  ...
  const { pushModal, closeModal, isOpen } = useModalStore();
  const isOpenRef = useRef(isOpen);

  // isOpen change hone pe ref update karo
  useEffect(() => {
  ...
  `}
        >
          <div className="p-4 flex flex-col h-full">
            <div className="logo flex items-center justify-between mb-6 pt-2 flex-shrink-0">
              <img
