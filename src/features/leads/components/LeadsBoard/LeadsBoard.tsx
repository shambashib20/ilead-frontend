  ...
  ({
    ...
    return (
      <div className="w-full mx-auto relative">
        ...
        <div
          ref={scrollRef}
          className={`overflow-x-auto [&::-webkit-scrollbar]:w-[4px]  [&::-webkit-scrollbar-track]:rounded-full  [&::-webkit-scrollbar-track]:bg-[#fff]                  [&::-webkit-scrollbar-thumb]:rounded-full                [&::-webkit-scrollbar-thumb]:bg-[#173b78] hover:[&::-webkit-scrollbar-thumb]:bg-[#2554a5] cursor-grab cursor-${
        ...
        >
          <div className="mt-10 inline-flex gap-4 overflow-x-auto pb-3 [&::-webkit-scrollbar]:w-[4px]                 [&::-webkit-scrollbar-track]:rounded-full                [&::-webkit-scrollbar-track]:bg-[#fff]                [&::-webkit-scrollbar-thumb]:rounded-full                [&::-webkit-scrollbar-thumb]:bg-[#173b78] hover:[&::-webkit-scrollbar-thumb]:bg-[#2554a5]">
            {statuses.map((status) => (
              <StatusColumn
                key={status._id}
                status={status}
